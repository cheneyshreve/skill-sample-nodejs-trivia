...
module.exports = {
    ...
    QUESTIONS_EN_US: [
        {
            'What was the first animal species to be domesticated, was it the?': [
                'dog',
                'bird',
                'horse',
                'snake',
        ...
        },
        {
            'What is a water bear?': [
                ...
                'A mythical animal popular in Russian folklore',
            ],
        },
        {
        ...
        {
            'Where was the first bicycle introduced?': [
                'Europe',
                'Asia',
                'Americas',
                'Mesopotamia',
        ...
        {
            'What does d to d transition describe?': [
        ...
        {
            'Which of the following is true about snow?': [
        ...
        {
            'Which of the following has the highest ranking on the Mohs Hardness Scale?': [
                'Corundum',
                'Quartz',
                'Orthoclase',
                'Topaz',
        ...
        {
            'Limnic eruptions describe what process?': [
        ...
        {
            'Spelunking describes what recreational activity?': [
                'Caving',
                'Ice climbing',
                'Diving',
                'Canyoning',
        ...
        {
            'Which of the following have geneticists not stored in DNA?': [
                'The Bible',
